...
export default function ArbitrumIcon({
  ...
  return (
    <Svg
      ...
      <path
        fill="#2C374B"
        d="M21.4,27.9c6.3,0,11.3-5.1,11.3-11.3c0-6.3-5.1-11.3-11.3-11.3c-6.3,0-11.3,5.1-11.3,11.3
	C10.1,22.8,15.2,27.9,21.4,27.9z"
      ...
      <path
        ...
        clipRule="evenodd"
        fill="#FFFFFF"
        d="M27.6,12.5c-0.1-0.1-5-3-5.6-3.2c-0.2-0.1-0.7-0.2-1-0.1c-0.3,0.1-5.5,3.1-5.7,3.3c-0.1,0.1-0.2,0.3-0.3,0.4
	...
	C27.8,12.8,27.6,12.6,27.6,12.5z M27,18.6L27,18.6L27,18.6L27,18.6z"
      ...
      <path
        ...
        clipRule="evenodd"
        fill="#98BCDC"
        d="M15.9,13.4l5.5-3.2l5.5,3.2v6.4l-5.5,3.2l-4.1-2.3l-0.5,0.9l4.5,2.6c0.1,0.1,0.2,0.1,0.3,0l6.3-3.6
	...
	c0,0.1,0.1,0.2,0.2,0.3l1.3,0.7l0.6-0.9l-0.9-0.5V13.4z"
      />
      <path fill="#FFFFFF" d="M23.8,13.4l-2.1,0l-4.9,8l1.7,1L23.8,13.4z" />
      <path
        fill="#FFFFFF"
        d="M18.5,14.2c0.5-0.8,1.9-0.8,2.5-0.7l-4.8,7.7c-0.2-0.1-0.6-0.3-0.9-0.5c-0.4-0.2-0.5-0.2-0.5-0.5v-0.4
